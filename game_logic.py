...
class GameLogic:
    empty_batsman =  {"name":"", "Batascore":0,"is_striker":True}
    batsmen = []
    bowlers = []
    match_details = None
    ...
    def __init__(self) -> None:
        ...
        {"name":"batsman_2", "runs":0,"balls":0,"is_striker":False,"is_out":False}] # array(list) of objects (dictoneries)

        self.bowlers = [
        {"name":"bowler_1", "overs":"0.0","balls":0,"maidens":0,"runs":0,"wickets":0,"is_current_bowler":True}] 
    ...
    def update_ball(self,runs,is_wicket,match_details):
        ...
        is_over_end, match_details["batting_team"]["stats"]["overs"] = self.is_over_end(match_details["match_balls"],match_details["balls_per_over"])
